...
describe("F0", () => {
  ...
  it("traverse calls onFile callback for each file", async () => {
    ...
    // directory.html has 5 files: file with spaces.txt, file-with-dashes.html, file_with_underscores.json, simple.txt, файл.txt
    // special-files.html has 15 files (excluding directories)
  ...
  it("traverse calls onDirectory callback for each directory", async () => {
    ...
    // directory.html has 1 directory: level2
    // special-files.html has 3 directories: hello, level1, many-files
